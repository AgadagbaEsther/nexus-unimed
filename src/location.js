...
export const buildingMap = {
    // CBT center doors, gates, and the CBT unit itself
    "cbt_upstairs": {
        body: "cbt_center_upstairs",
        slicerTarget: "annex",
        useSlicer: true,
    ...
    // E-library and its various doors
    "e-lib-door2": {
        body: "e-lib_inner_door1",
        slicerTarget: "e-lib",
        useSlicer: true,
        sliceOffset: 2.5,
    ...
    "e-lib-door5": {
        body: "e-lib_inner_door5",
        slicerTarget: "e-lib",
        useSlicer: true,
        sliceOffset: 2.5,
        displayName: "Director of ICT",
        description: "Head of the ICT department."
    },
    "e-lib-door6": {
        body: "e-lib_inner_door6",
        slicerTarget: "e-lib",
        useSlicer: true,
        sliceOffset: 2.5,
    ...
    // Health center and its doors
    "healthcenterdoor1": {
        body: "healthcenter_door1",
